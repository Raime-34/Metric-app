...
func easyjson2220f231DecodeMetricappInternalModel(in *jlexer.Lexer, out *Metrics) {
...
func easyjson2220f231EncodeMetricappInternalModel(out *jwriter.Writer, in Metrics) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Metrics) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2220f231EncodeMetricappInternalModel(&w, v)
...
func (v *Metrics) UnmarshalJSON(data []byte) error {
	...
	easyjson2220f231DecodeMetricappInternalModel(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Metrics) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2220f231DecodeMetricappInternalModel(l, v)
}
